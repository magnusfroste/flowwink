...
| H11 | **Resumption** | Pause a multi-step chain and resume exactly where it stopped | approval-resumption + durable run lifecycle shipped (Phases 0–1); resumer (Phase 2) queued | **building** |
