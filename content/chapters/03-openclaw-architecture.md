...
Flowwink is an open-source, self-hosted business platform — think Odoo meets Supabase. Each business runs its own isolated instance (self-hosted or in a managed cloud container), just like n8n or Supabase itself. It bundles capabilities that normally require 5-10 separate SaaS tools:

| Module | What it does |
|--------|-------------|
| **CMS** | Pages, layouts, themes — the company's web presence |
| **Blog** | Articles, categories, SEO, scheduled publishing |
| **CRM** | Contacts, companies, leads, deals pipeline, engagement scoring |
| **Forms** | Contact forms, surveys, lead capture with conditional logic |
| **Newsletter** | Subscriber management, campaign creation, send + tracking |
| **Booking** | Appointment scheduling with availability rules |
| **E-Commerce** | Products, orders, inventory, checkout |
| **Webinars** | Event registration, reminders, follow-up |
| **Tickets** | Support ticket system with priority and assignment |
| **Knowledge Base** | FAQ and docs powering the public chat agent |
| **Analytics** | Site stats, page views, conversion tracking |
