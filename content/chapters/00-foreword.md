...
> **How to read this:**
> Start with chapters 1–5 for conceptual grounding. Jump to chapter 6 (Control Plane) if you're a builder. Read chapter 14 (Governance) if you're a manager. Read all of it if you want to understand the full picture — it's written as a coherent argument, not just a reference.
