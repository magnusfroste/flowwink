 ...
 *           manage_opening_balances, manage_chart_of_accounts, suggest_accounting_template
 * - Automation: Invoice Reconciliation (daily check for unbooked invoices)
 * 
 * Note: Expense skills (manage_expenses, analyze_receipt) have been moved to
 * the dedicated expenses module bootstrap (./expenses.ts).
 */
