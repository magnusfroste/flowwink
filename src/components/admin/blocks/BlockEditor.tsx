...
const DEFAULT_BLOCK_DATA: BlockDataMap = {
  hero: { title: 'Ny Hero', subtitle: '', backgroundType: 'image', heightMode: 'auto', contentAlignment: 'center', overlayOpacity: 60, parallaxEffect: false, videoAutoplay: true, videoLoop: true, videoMuted: true },
