...
export const flowwinkPlatformTemplate: StarterTemplate = {
  ...
  products: [
    {
      name: 'Starter Kit',
      description: 'Everything you need to launch your first FlowWink site. Includes 3 templates, basic chat config, and setup guide.',
      price_cents: 0,
      currency: 'USD',
    ...
    {
      name: 'Pro Template Bundle',
      description: '12 premium industry templates with pre-configured FlowPilot souls, blog posts, and knowledge bases. Ship in hours, not weeks.',
      price_cents: 9900,
      currency: 'USD',
      type: 'one_time' as const,
    ...
    {
      name: 'FlowPilot AI Credits',
      description: '10,000 AI tokens for FlowPilot operations — blog writing, lead qualification, SEO audits, and autonomous tasks.',
      price_cents: 4900,
      currency: 'USD',
      type: 'one_time' as const,
    ...
    },
    {
      ...
      description: 'Complete UI component library with 500+ blocks, dark mode variants, and brand-ready design tokens.',
      price_cents: 7900,
      currency: 'USD',
      type: 'one_time' as const,
    ...
    },
    {
      ...
      description: 'We run your FlowWink instance — automatic updates, daily backups, SSL, CDN, and 99.9% uptime SLA.',
      price_cents: 4900,
      currency: 'USD',
    ...
    },
    {
      ...
      description: 'Unlimited sites, priority support, custom integrations, and dedicated onboarding. For agencies and large teams.',
      price_cents: 29900,
      currency: 'USD',
      type: 'recurring' as const,
