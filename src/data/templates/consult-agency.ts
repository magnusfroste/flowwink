      ...
      blocks: [
        ...
        // CLIENT LOGOS — first trust signal, above the fold on scroll
        {
          ...
          data: {
            ...
            logos: [
              { id: 'cl1', name: 'Volvo Group', logo: 'https://logo.clearbit.com/volvo.com' },
              { id: 'cl2', name: 'Ericsson', logo: 'https://logo.clearbit.com/ericsson.com' },
              { id: 'cl3', name: 'SKF', logo: 'https://logo.clearbit.com/skf.com' },
              { id: 'cl4', name: 'AstraZeneca', logo: 'https://logo.clearbit.com/astrazeneca.com' },
              { id: 'cl5', name: 'Scania', logo: 'https://logo.clearbit.com/scania.com' },
              { id: 'cl6', name: 'ABB', logo: 'https://logo.clearbit.com/abb.com' },
              { id: 'cl7', name: 'Atlas Copco', logo: 'https://logo.clearbit.com/atlascopco.com' },
              { id: 'cl8', name: 'Sandvik', logo: 'https://logo.clearbit.com/sandvik.com' },
            ],
            layout: 'scroll',
            variant: 'grayscale',
            logoSize: 'md',
