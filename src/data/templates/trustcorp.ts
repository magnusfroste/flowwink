    ...
    blocks: [
      ...
      },
      {
        ...
        data: {
          ...
          logos: [
            { id: 'l1', name: 'SEB', logo: 'https://logo.clearbit.com/sebgroup.com' },
            { id: 'l2', name: 'Nordea', logo: 'https://logo.clearbit.com/nordea.com' },
            { id: 'l3', name: 'Swedbank', logo: 'https://logo.clearbit.com/swedbank.com' },
            { id: 'l4', name: 'Handelsbanken', logo: 'https://logo.clearbit.com/handelsbanken.se' },
            { id: 'l5', name: 'Vattenfall', logo: 'https://logo.clearbit.com/vattenfall.com' },
            { id: 'l6', name: 'Telia', logo: 'https://logo.clearbit.com/teliacompany.com' },
            { id: 'l7', name: 'ICA Gruppen', logo: 'https://logo.clearbit.com/ica.se' },
          ],
          layout: 'scroll',
          variant: 'grayscale',
          logoSize: 'md',
