  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        ...
        secondaryContent: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: '**CMS** — pages, blocks, blog, knowledge base, docs, wiki, media, forms, newsletter, SEO/AEO' }] }, { type: 'paragraph', content: [{ type: 'text', text: '**CRM** — leads, companies, deals, quotes, customer 360, sales intelligence, tickets, SLA, bookings, live support' }] }, { type: 'paragraph', content: [{ type: 'text', text: '**ERP** — orders, inventory, shipping, purchasing, invoicing, accounting, reconciliation, expenses, payroll, HR, projects, timesheets, manufacturing' }] }] },
        layout: 'text-text',
      },
    },
    {
    ...
    },
    {
      ...
      data: {
        ...
        secondaryContent: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: '**Single-tenant** — no shared database, no noisy neighbours' }] }, { type: 'paragraph', content: [{ type: 'text', text: '**Open source** — MIT, auditable line by line' }] }, { type: 'paragraph', content: [{ type: 'text', text: '**Bring your own model** — OpenAI · Gemini · local' }] }, { type: 'paragraph', content: [{ type: 'text', text: '**Bring your own agent** — FlowPilot, or anything that speaks MCP' }] }] },
        layout: 'text-text',
      },
    },
    {
  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        ...
        secondaryContent: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: '**Per process you get**' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• Modules involved and their role' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• Step-by-step flow' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• State machines and what each transition writes' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• Coverage: human / FlowPilot / external agent' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• Known gaps' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• Webhook events emitted' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• Best for — and explicitly not for' }] }] },
        layout: 'text-text',
      },
    },
    {
  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        ...
        secondaryContent: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: '**Silent** — read-only lookups and reports' }] }, { type: 'paragraph', content: [{ type: 'text', text: '**Notify** — acts, then tells you what it did' }] }, { type: 'paragraph', content: [{ type: 'text', text: '**Approve** — proposes, waits for a human, then executes' }] }, { type: 'paragraph', content: [{ type: 'text', text: '**Audited** — always. Actor, arguments, outcome, timestamp.' }] }] },
        layout: 'text-text',
      },
    },
    {
  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        ...
        secondaryContent: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: '**Always included**' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• CMS with blocks, blog and knowledge base' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• CRM with leads, companies and deals' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• The ERP core you switch on as you grow' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• FlowPilot, or your own agent over MCP' }] }, { type: 'paragraph', content: [{ type: 'text', text: '• Self-hosted, single-tenant, open source' }] }] },
        layout: 'text-text',
      },
    },
    {
