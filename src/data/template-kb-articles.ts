    ...
    articles: [
      {
        ...
        answer_text: 'FlowWink is a modern, open-source content management system built for speed, simplicity, and flexibility. It combines a visual block editor with a headless API, giving you the best of both worlds. Key features include: Visual Block Editor with 43+ block types, Headless API for custom frontends and mobile apps, Self-Hostable on your own infrastructure, AI-Powered content generation and chat, and Built-in Modules for blog, newsletter, CRM, knowledge base, and e-commerce.',
        is_featured: true,
        include_in_chat: true,
      },
      {
  ...
  // ===== MODULES OVERVIEW =====
  {
    ...
    articles: [
      ...
      },
      {
        ...
        answer_text: 'The Pages module is the core content creation system. It provides a visual block editor with 43+ block types, version history, scheduled publishing, and SEO settings. This is a core module and cannot be disabled.',
        is_featured: true,
        include_in_chat: true,
      },
      {
