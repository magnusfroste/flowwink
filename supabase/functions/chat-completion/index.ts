...
function buildEmailRegister(ctx?: { subject?: string; from?: string; mailbox?: string }): string {
  ...
  return (
    ...
    'Answer from the identity, the website content you were given, and the tools you have: for prices, durations, what can be booked and when, ' +
    'call the services and availability tools BEFORE concluding that something is unknown — a price you did not look up is not a missing price. ' +
