      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            stage: { type: 'string' },
            lead_id: { type: 'string', description: 'Existing lead UUID. Required for create UNLESS company_id or company_name is supplied (then a lead is auto-created/reused).' },
            company_id: { type: 'string', description: 'Optional: when creating a deal company-centrically, supply company_id (or company_name) and a lead will be auto-created.' },
            company_name: { type: 'string', description: 'Optional: company name to fuzzy-match instead of company_id.' },
